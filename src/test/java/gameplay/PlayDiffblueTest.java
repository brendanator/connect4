...
public class PlayDiffblueTest {
  ...
  public void findNextMoveTest() {
    ...
    // Act
    Position actualFindNextMoveResult =
        play.findNextMove(new Position(), Difficulty.EASY);
    ...
    ArrayList<Position> possibleMoves =
        actualFindNextMoveResult.getPossibleMoves();
    ...
    assertEquals(
        "Value: 6  DoubleThreat: NONE  Zugwang: NONE  Threats: 0, 0  Minor Threats: 0, 0  Blockers: 6 0",
    ...
    assertEquals(
        "Value: -13  DoubleThreat: NONE  Zugwang: NONE  Threats: 0, 0  Minor Threats: 0, 0  Blockers: 6 19",
        actualToStringResult3);
    assertEquals(
        "Value: -7  DoubleThreat: NONE  Zugwang: NONE  Threats: 0, 0  Minor Threats: 0, 0  Blockers: 6 13",
    ...
    assertEquals(
        "Value: -2  DoubleThreat: NONE  Zugwang: NONE  Threats: 0, 0  Minor Threats: 0, 0  Blockers: 6 8",
