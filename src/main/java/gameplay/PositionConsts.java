...
public class PositionConsts {
  ...
  public static final long[] HORIZONTAL_ODD_FOURS_IN_A_ROW =
      horizontalOddFoursInARow();
  public static final long[] HORIZONTAL_EVEN_FOURS_IN_A_ROW =
      horizontalEvenFoursInARow();
